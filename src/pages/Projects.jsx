  ...
  return (
    <div className="container">
      <div className="flex flex-col items-center gap-5 pt-5 md:pt-10">
        ...
        <p data-aos="fade-down" data-aos-delay="200" className="text-white-white font-normal font-Inter text-lg md:text-[24px] leading-[100%]">
        ...
        >
          {projectdata.map((item, index) => (
            <SwiperSlide key={index}>
              <div data-aos={index % 3 === 0 ? "fade-up" : index % 3 === 1 ? "fade-up" : "fade-down"}
              ...
              >
                <a href={item.projectlink} target="_blank" rel="noopener noreferrer">
                  <img src={item.projectimg} alt="" className="h-[215px]"  />
                  <div className="px-5 pt-5 pb-6">
                    <h1
